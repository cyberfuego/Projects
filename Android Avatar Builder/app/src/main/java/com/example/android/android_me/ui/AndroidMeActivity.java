...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    int headposition, legpostion, bodyposition ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headposition = bundle.getInt("head");
        legpostion = bundle.getInt("leg") ;
        bodyposition = bundle.getInt("body");
        ...
        if(savedInstanceState == null) {
            ...
            legFragment.setListIndex(legpostion);
            fragmentManager.beginTransaction()
